%helper function for AffineTransform

function R= rotationmat3D(rad,Axis)
%function R= rotationmat3D(radians,Axis)
%
% creates a rotation matrix such that R * x 
% operates on x by rotating x around the origin rad radians around line
...
%
%rad = rand(4,1);
%rotationmat3D(rad(1),[rad(2),rad(3),rad(4)]) * rotationmat3D(-rad(1),[rad(2),rad(3),rad(4)])
%
% example2: 
